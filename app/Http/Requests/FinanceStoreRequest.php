...
class FinanceStoreRequest extends FormRequest
{
    ...
    {
        return [
            'code' => 'required|string|unique:finances,code',
    ...
    public function messages()
    {
        ...
        return [
            'code.unique' => "Keuangan $this->type untuk " . ($unit ? "[$unit->name] " : NULL) . ($this->year ? "[$this->year] " : NULL) . ($period ? "[$period->name] " : NULL) . "sudah ada sebelumnya",
        ];
    }
