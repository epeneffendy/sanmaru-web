                ...
                <div class="widget-content">
                    ...
                    <form role="form" method="POST" action="{{ $action }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control selectpicker" name="status" id="status" data-style="btn-success">
                                    <option value="">Pilih Status</option>
                                    <option value="approved" {{ @$dispensation['status'] == 'approved' ? 'selected' : '' }}>Disetujui</option>
                                    <option value="rejected" {{ @$dispensation['status'] == 'rejected' ? 'selected' : '' }}>Ditolak</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group" id="reason_container" style="display: {{ @$dispensation['status'] ? 'block' : 'none' }};">
                            ...
                            <div class="col-sm-10">
                                ...
                                @if(@$dispensation['attachment'])
                                    <div style="margin-top: 10px;">
                                        <a href="{{ asset('storage/' . $dispensation['attachment']) }}" target="_blank" class="btn btn-sm btn-info">Lihat Lampiran</a>
                                    </div>
                                @endif
                            </div>
                        </div>
