    ...
    <div class="panel panel-default panel-collapse">
      ...
      <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="true">
        <div class="panel-body">
            <div class="form-horizontal padding-5">
      ...
      <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour" aria-expanded="false">
        <div class="panel-body">
            <div class="form-horizontal padding-5">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Akta Kelahiran</label>
                    <div class="col-sm-10">
                        @if ($data->birth_certificate !== null)
                            <a href="{{ $data->getBirtCertificateImageUrl() }}" target="_blank">
                                <img src="{{ $data->getBirtCertificateImageUrl() }}" alt="Akta Kelahiran" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="col-sm-10">
                        @if ($data->photo !== null)
                            <a href="{{ $data->getPhotoImageUrl() }}" target="_blank">
                                <img src="{{ $data->getPhotoImageUrl() }}" alt="Foto 3x4" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">KTP Orang Tua</label>
                    <div class="col-sm-10">
                        @if ($data->parent_identity_card !== null)
                            <a href="{{ $data->getParentIdentityCardImageUrl() }}" target="_blank">
                                <img src="{{ $data->getParentIdentityCardImageUrl() }}" alt="KTP Orang Tua" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Akta Pernikahan Orangtua</label>
                    <div class="col-sm-10">
                        @if ($data->marriage_certificate !== null)
                            <a href="{{ $data->getMarriageCertificateImageUrl() }}" target="_blank">
                                <img src="{{ $data->getMarriageCertificateImageUrl() }}" alt="Akta Pernikahan Orangtua" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Kartu Keluarga</label>
                    <div class="col-sm-10">
                        @if ($data->family_card !== null)
                            <a href="{{ $data->getFamilyCardImageUrl() }}" target="_blank">
                                <img src="{{ $data->getFamilyCardImageUrl() }}" alt="Kartu Keluarga" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="row">
                        <label class="control-label col-sm-2" for="image">Raport</label>
                            @forelse (@$data->report_cards as $report)
                                @if ($loop->index % 2 === 0)
                                    </div><div class="row" style="margin-top: 5px;"><div class="col-sm-4 col-sm-offset-2">
                                @else
                                    <div class="col-sm-4">
                                @endif
                                    <a href="{{ $data->getRaportImageUrl($report) }}" target="_blank">
                                        <img src="{{ $data->getRaportImageUrl($report) }}" alt="Raport" style="max-width: 300px; height: auto;">
                                    </a>
                                </div>
                            @empty
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Piagam Penghargaan</label>
                    <div class="col-sm-10">
                        @if ($data->award_photo !== null)
                            <a href="{{ $data->getAwardPhotoImageUrl() }}" target="_blank">
                                <img src="{{ $data->getAwardPhotoImageUrl() }}" alt="Piagam Penghargaan" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Kartu Baptismal</label>
                    <div class="col-sm-10">
                        @if ($data->baptismal_certificate !== null)
                            <a href="{{ $data->getBaptismalCertificateImageUrl() }}" target="_blank">
                                <img src="{{ $data->getBaptismalCertificateImageUrl() }}" alt="Kartu Baptismal" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Angket Peminatan</label>
                    <div class="col-sm-10">
                        @if ($data->angket_peminatan !== null)
                            <a href="{{ $data->getAngketPeminatanFileUrl() }}" target="_blank">
                                <img src="{{ $data->getAngketPeminatanFileUrl() }}" alt="Angket Peminatan" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Rekomendasi BK</label>
                    <div class="col-sm-10">
                        @if ($data->rekomendasi_bk !== null)
                            <a href="{{ $data->getRekomendasiBkImageUrl() }}" target="_blank">
                                <img src="{{ $data->getRekomendasiBkImageUrl() }}" alt="Rekomendasi BK" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Surat Pernyataan</label>
                    <div class="col-sm-10">
                        @if ($data->statement_letter !== null)
                            <a href="{{ $data->getStatementLetterFileUrl() }}" target="_blank">
                                <img src="{{ $data->getStatementLetterFileUrl() }}" alt="Surat Pernyataan" style="max-width: 300px; height: auto;">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Kartu Golongan darah</label>
                    <div class="col-sm-10">
                        <a href="{{ $data->getKartuGolonganDarahImageUrl() }}" target="_blank">
                            <img src="{{ $data->getKartuGolonganDarahImageUrl() }}" alt="Kartu Golongan Darah" style="max-width: 300px; height: auto;">
                        </a>
                    </div>
                </div>
                <hr/>
                ...
                @if ($data->kms !== null)
                <div class="form-group">
                    <label class="control-label col-sm-2" for="image">Kartu Menuju sehat (KMS)</label>
                    <div class="col-sm-10">
                        <a href="{{ $data->getKmsImageUrl() }}" target="_blank">
                            <img src="{{ $data->getKmsImageUrl() }}" alt="Kartu Menuju Sehat" style="max-width: 300px; height: auto;">
                        </a>
                    </div>
                </div>
                <hr/>
    ...
    <div class="panel panel-default panel-collapse">
      ...
      <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive" aria-expanded="false">
        <div class="panel-body">
            <div class="form-horizontal padding-5">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="m_job">Nomor Registrasi</label>
                    <div class="col-sm-10">
                        <div class="form-control"> {{ @$data['register_number'] }}</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="m_job">Sekolah Asal</label>
                    <div class="col-sm-10">
                        <div class="form-control"> {{ @$data['origin_school'] }}</div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="m_job">Daftar pada Unit</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="m_job">Pilihan Kelas</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="m_job">Tanggal Daftar</label>
                    <div class="col-sm-10">
