...
@section('content')
    ...
    <div class="page-header">
        <h1 class="title">Data Master Pembelian Produk {{ucwords($type)}}</h1>
        <ol class="breadcrumb">
            <li>Shop</li>
            <li><a href="{{route('admin.product-order.index')}}">Pembelian Produk {{ucwords($type)}}</a></li>
            ...
            <div class="col-md-12">
                <div class="widget ">
                    <div class="widget-header">
                        <h3>{{$status_header}} Pembelian Produk {{ucwords($type)}}</h3>
                    </div> <!-- /widget-header -->
