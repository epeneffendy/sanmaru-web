...
@section('content')
    <div class="page-header">
        <h1 class="title">Lapoaran Dana Pengembangan</h1>
        <ol class="breadcrumb">
            <li>Report</li>
            <li class="active">Dana Pengembangan</li>
        </ol>
    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body table-responsive">
                        ...
                        <div class="button-collection" style="margin: 15px 0">
                            <a href="{{ route('admin.report.development-report.export', request()->except('page')) }}"
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form role="form" autocomplete="off" method="GET"
                                    action="{{ route('admin.report.development-report.index') }}">
                                    <div class="row">
                        ...
                        <h1 class="text-center" style="margin: 0px;">Laporan Pembayaran Dana Pengembangan</h1>
