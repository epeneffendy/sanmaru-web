                ...
                <div class="panel panel-default">
                    <div class="panel-body table-responsive">
                        ...
                        <div class="button-collection" style="margin: 15px 0">
                            <a href="{{ route('admin.report.payment-ppdb-report.export', request()->except('page')) }}"
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form role="form" autocomplete="off" method="GET"
                                    action="{{ route('admin.report.payment-ppdb-report.index') }}">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label for="type" class="form-label">Laporan</label>
                                            <select name="type" class="form-control input-sm">
                                                <option value="all">Semua Pembayaran Siswa</option>
                                                <option value="development">Pembayaran Uang Pengembangan</option>
                                            </select>
                                        </div>
                        ...
                        @if ($type == 'all')
                            <h1 class="text-center" style="margin: 0px;">Laporan Pembayaran Siswa</h1>
                            @include('administrator.report.payment-ppdb-report.partials._report_all_payment')
                        @else
                            <h1 class="text-center" style="margin: 0px;">Laporan Pembayaran Uang Pengembangan</h1>
                            @include('administrator.report.payment-ppdb-report.partials._report_development_payment')
                        @endif
                    </div>
                </div>
            </div>
