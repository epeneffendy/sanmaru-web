            ...
            <div class="col-md-12 pading-b-20 margin-b-20">
                <div class="panel panel-default">
                    <div class="panel-title">
                        History Import - Cek Pembayaran Seragam
                    </div>
                    <div class="panel-body table-responsive">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form role="form" autocomplete="off" method="GET" action="{{ route('admin.uniform-payment.history') }}">
                                    ...
                                    <a href="{{ route('admin.uniform-payment.history') }}" class="pull-right btn btn-sm btn-warning">
                            ...
                            <tbody>
                                ...
                                @foreach ($importJobs as $key => $importJob)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.uniform-payment.detail-history', ['importJobId' => $importJob->id]) }}">details</a><br>
