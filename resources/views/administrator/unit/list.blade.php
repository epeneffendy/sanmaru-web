                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <div class="button-collection">
                            <a href="{{ route('admin.unit.export') }}" download class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Export</a>
                            <a href="{{ route('admin.unit.export', ['template-only']) }}" download class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Download Template .xls</a>
                        ...
                        <div class="fixed-table-head period">
                            <table id="datatables-master-unit" class="table display">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
                                ...
                                @foreach($units as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.unit.show',$value['id']) }}" title="Show" class="btn btn-xs btn-success">
                                                <icon class="icon-plus"><i class="fa fa-eye"></i></icon>
                                            </a>
                                            <a href="{{ route('admin.unit.edit',$value['id']) }}" class="btn btn-xs btn-default">
                                                <icon class="icon-plus"><i class="fa fa-pencil"></i></icon>
                                            </a>
                                            <a href="{{ route('admin.unit.delete',$value['id']) }}" class="btn btn-xs btn-danger"
                        ...
                        <div class="btn-group padding-t-10 pull-right">
                            <a href="{{ route('admin.unit.add') }}" class="btn btn-sm btn-success">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form">
                        <form class="fieldset-form" method="POST" enctype="multipart/form-data" action={{ route('admin.unit.import')}}>
                            @csrf
                            <fieldset>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            $('#datatables-master-unit').DataTable();
