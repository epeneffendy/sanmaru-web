                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <div class="button-collection">
                            <a href="{{ route('admin.vendor.export') }}" download class="btn btn-success btn-sm"><i class="fa fa-file-excel-o"></i> Export</a>
                            <a href="{{ route('admin.vendor.export', ['template-only']) }}" download class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Download Template .xls</a>
                        ...
                        <div class="fixed-table-head period">
                            <table id="datatables-master-vendor" class="table display">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Name</th>
                                ...
                                @foreach($data as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{$value['pic']}}</td>
                                        <td>{{$value['nota_number']}}</td>
                                        <td>{{$value['nota_date']}}</td>
                                        <td>
                                            <a href="{{ route('admin.vendor.edit',$value['id']) }}" class="btn btn-xs btn-default">
                                                <icon class="icon-plus"><i class="fa fa-pencil"></i></icon>
                                            </a>
                                            <a href="{{ route('admin.vendor.delete',$value['id']) }}" class="btn btn-xs btn-danger"
                        ...
                        <div class="btn-group padding-t-10 pull-right">
                            <a href="{{ route('admin.vendor.add') }}" class="btn btn-sm btn-success">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form">
                        <form class="fieldset-form" method="POST" enctype="multipart/form-data" action={{ route('admin.vendor.import')}}>
                            @csrf
                            <fieldset>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            $('#datatables-master-vendor').DataTable();
