...
<div class="email-verification-content">
    ...
    <br>
    <p>Kami informasikan bahwa periode pembayaran <b>Uang Kegiatan</b> pada periode pendaftaran <b>{{ optional($student->period)->name }}</b> telah dibuka mulai tanggal <b>{{ \Carbon\Carbon::parse($periode['start'])->translatedFormat('d F Y') }}</b> hingga <b>{{ \Carbon\Carbon::parse($periode['end'])->translatedFormat('d F Y') }}</b>.</p>
