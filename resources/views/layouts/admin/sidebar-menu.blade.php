...
<div class="sidebar clearfix" style="overflow-y: auto;">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('admin.facility-category.index') }}"
                           class="{{($nav['child']=='facility-category')?'active':''}}">
                            <span class="icon color12"><i class="fa fa-check-square-o"></i></span>Facility Category</a>
                    </li>
                ...
                <ul class="treeview-menu">
                    @if(\App\Helpers\Helper::isShopRole())
                        ...
                        <li><a href="{{ route('admin.vendor.index') }}"
                               class="{{($nav['child']=='vendor')?'active':''}}"><span
                        ...
                        <li><a href="{{ route('admin.product-acceptance.index') }}" class="{{($nav['child']=='product-acceptance')?'active':''}}"><span
                                    class="icon color12"><i class="fa fa-shirtsinbulk"></i></span>Update Stock</a></li>
                        ...
                        <li><a href="{{ route('admin.uniform-payment.index') }}"
                               class="{{($nav['child']=='uniform-payment')?'active':''}}"><span class="icon color12"><i
                                        class="fa fa-dollar"></i></span>Cek pembayaran</a></li>
                    @endif
                    @if(\App\Helpers\Helper::isShopRole() || \App\Helpers\Helper::isPpdbRole())
                    ...
                    @endif --}}
                        ...
                        <li><a href="{{ route('admin.distribution-order.index') }}"
                               class="{{($nav['child']=='distribution-order')?'active':''}}"><span class="icon color12"><i
                                        class="fa fa-sitemap"></i></span>Distribusi Pesanan</a></li>
    ...
    <ul class="sidebar-panel sidebar-nav">
        <li class="sidetitle">AKUN</li>
            @if (\App\Helpers\Helper::isAdminRole())
                <li>
                    <a href="{{ route('admin.user.index') }}" class="{{($nav['child']=='user')?'active':''}}"><span
                            class="icon color12"><i
                                class="fa fa-users"></i></span>Pengguna</a>
                </li>
            @endif
        <li>
            <a href="{{ route('admin.logout') }}"><span class="icon color12"><i class="fa fa-power-off"></i></span>Keluar</a>
        </li>
    </ul>
