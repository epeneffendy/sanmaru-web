        ...
        @if (\App\Helpers\Helper::isPpdbRole())
            <li class="treeview {{ $nav['parent'] == 'ppdb' ? 'active menu-open' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('admin.ppdb-suspended.index') }}"
                            class="{{ $nav['child'] == 'ppdb-suspended' ? 'active' : '' }}">
                            <span class="icon color12"><i class="fa fa-exchange"></i></span>Penangguhan PPDB</a></li>
