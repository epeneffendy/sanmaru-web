  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Route::is('webunit.about*') ? 'active' : '' }}" href="{{ route('webunit.about.about', ['webunit' => $webUnit]) }}">
              About Us
          </a>
          {{-- <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li id="sub-menu">
              <a href="" class="nav-link dropdown-item dropdown-toggle" data-toggle="dropdown">SD Santa Maria</a>
              <ul class="dropdown-menu">
                <li><a class="nav-link dropdown-item" href="{{ route('webunit.about.history', ['webunit' => $webUnit]) }}">SD Surabaya</a></li>
                <li><a class="nav-link dropdown-item" href="{{ route('webunit.about.history', ['webunit' => $webUnit]) }}">SD Sidoarjo</a></li>
              </ul>
            </li>
          </ul> --}}
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('ppdb.profile', 'SD-SURABAYA' ) }}">PPDB</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://esamasu.sanmarosu-jatim.sch.id/">Moodle</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="https://sanmarustory-sd.fun/countdown">Memorabilia</a>
        </li>
      </ul>
    </div>
  </div>
