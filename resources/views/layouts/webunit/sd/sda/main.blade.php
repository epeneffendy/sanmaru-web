...
<html lang="en">
  <head>
    ...
    <!-- BASE CSS -->
    <link href="{{asset('web-sd/sda/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('web-sd/sda/css/bootnavbar.css')}}" rel="stylesheet">
    ...
    <!-- YOUR CUSTOM CSS -->
    <link href="{{asset('web-sd/sda/css/style.css')}}" rel="stylesheet">
    <link href="{{asset('web-sd/sda/css/responsive.css')}}" rel="stylesheet">
  ...
  <body>
    ...
    @endif
    @include('layouts.webunit.sd.sda.navbar')
    ...
    @include('layouts.webunit.sd.sda.footer')

    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.9.2/dist/umd/popper.min.js" ></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.min.js" integrity="sha384-Atwg2Pkwv9vp0ygtn1JAojH0nYbwNJLPhwyoVbhoPwBhjQPR5VtM2+xf0Uwh9KtT" crossorigin="anonymous"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.slim.min.js"></script>
    <script src="{{asset('web-sd/sda/js/bootnavbar.js')}}"></script>
