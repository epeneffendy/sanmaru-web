    ...
    <div class="container">
        <div class="row desktop-version">
            <div class="col-sm-1 footer-brand">
                <img src="{{ asset('web-smp/sby/images/Serviam-Green.png') }}" alt="Serviam Green">
            </div>
            ...
            <div class="col-sm-2">
                <div class="d-flex">
                    <a href="https://www.instagram.com/sanyupac" target="_blank">
                        <i class="icon icon-instagram mr-4"></i>
                    </a>
                    <a href="https://www.facebook.com/sanyupac/" target="_blank">
                        <i class="icon icon-facebook mr-4"></i>
                    </a>
                    <a href="https://www.youtube.com/channel/UCCGwMxyoHFmOOLaxYz7L-hA" target="_blank">
                        <i class="icon icon-youtube mr-4"></i>
                    </a>
                    <a href="https://www.tiktok.com/@sanyupac" target="_blank">
        ...
        <div class="mobile-version">
            <div class="row">
                <div class="col-2 footer-brand">
                    <img src="{{asset('web-smp/pacet/images/Serviam-Green.png')}}" alt="Serviam Green">
                </div>
