    ...
    <div class="container">
        <div class="row desktop-version">
            <div class="col-sm-1 footer-brand">
                <img src="{{ asset('web-smp/sda/images/Serviam-Green.png') }}" alt="Serviam Green">
            </div>
            ...
            <div class="col-sm-2">
                <div class="d-flex">
                    <a href="https://www.instagram.com/smp_sanmaru/" target="_blank">
                        <i class="icon icon-instagram mr-4"></i>
                    </a>
                    <a href="https://id-id.facebook.com/santamariasda/" target="_blank">
                        <i class="icon icon-facebook mr-4"></i>
                    </a>
                    <a href="https://www.youtube.com/channel/UC0CjUxg_bmaC3wu0W1X1LuA" target="_blank">
                        <i class="icon icon-youtube mr-4"></i>
                    </a>
                    <a href="https://www.tiktok.com/@smpsanmaru" target="_blank">
        ...
        <div class="mobile-version">
            <div class="row">
                <div class="col-2 footer-brand">
                    <img src="{{asset('web-kbtk/sda/images/Serviam-Green.png')}}" alt="Serviam Green">
                </div>
