    ...
    <div class="container-fluid max-w-100">
        <div class="card main-card overflow-hidden">
            ...
            <div class="card-body p-4 border-bottom">
                ...
                <div class="mt-4 pt-2">
                    <h6 class="fw-bold mb-3" style="color: #334155;">Alternatif Pembayaran</h6>
                    <div class="row g-3">
                            ...
                            <div class="p-3 rounded-4 shadow-sm h-100 d-flex flex-column"
                                ...
                                <div class="mt-auto">
                                    ...
                                    <div class="d-flex align-items-center mt-1 mb-2">
                                        <span class="va-number fs-5">{{ $va_full ?? 'Nomor VA Lunas' }}</span>
                        ...
                        <div class="col-md-6">
                            <div class="p-3 rounded-4 shadow-sm h-100 d-flex flex-column"
                                ...
                                <div class="mt-auto">
                                    <div class="va-label">Nomor Virtual Account</div>
                                    <div class="d-flex align-items-center mt-1 mb-2">
                                        <span class="va-number fs-5">{{ $va_partial ?? 'Nomor VA Sebagian' }}</span>
                                        <i class="fa fa-clipboard copy-icon ms-2" title="Salin Nomor VA"
                                            style="font-size: 1.1rem;"></i>
                                    </div>
                                    <div class="finance-label">Nominal</div>
                                    <div class="finance-value" style="color: #d97706;">Bebas (Sesuai Keinginan Anda)</div>
                                </div>
                            </div>
                        </div>
                    </div>
