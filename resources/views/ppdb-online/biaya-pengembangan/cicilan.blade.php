        ...
        <div class="col">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <p class="text-body">Biaya awal:
                        {{ \App\Helpers\PriceHelper::rupiah(0.5 * \App\Helpers\PriceHelper::development($ppdb)) }}</p>
                    <p class="text-body">Sisa angsuran: <span
                            id="sisa-angsuran">{{ \App\Helpers\PriceHelper::rupiah(0.5 * \App\Helpers\PriceHelper::development($ppdb)) }}</span>
                    </p>
                </div>
            </div>
                ...
                <div class="col">
                    <form action="" method="post">
                        ...
                        <div class="container data-siswa-table">
                            ...
                            <div class="row table-row">
                                <div class="col-4">
                                    ...
                                    <div class="col-9">
                                        <input type="date"
                                            value="{{ old('angsuran_1', !empty($ppdb->angsuran_1) ? $ppdb->angsuran_1 : \App\Helpers\Helper::tanggalCicilan($startDateAngsuran)) }}"
                                            name="angsuran_1" class="form-control" onchange="handler(value,0)"
                                            id="0">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                        <input type="number"
                                            value="{{ old('cicilan_1', @$ppdb->cicilan_1) ?: $angsuran }}" name="cicilan_1"
                                            class="form-control" placeholder="" onchange="checkCicilan(value,0)" readonly>
                            ...
                            <div class="row table-row">
                                <div class="col-4">
                                    ...
                                    <div class="col-9">
                                        <input type="date" value="{{ old('angsuran_2', @$ppdb->angsuran_2) }}"
                                            name="angsuran_2" class="form-control" onchange="handler(value,1)"
                                            id="1">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                        <input type="text"
                                            value="{{ old('cicilan_2', @$ppdb->cicilan_2) ?: $angsuran }}" name="cicilan_2"
                                            class="form-control" placeholder="" onchange="checkCicilan(value,1)" readonly>
                                        <div class="wrapper-content-mobile">
                            ...
                            <div class="row table-row">
                                <div class="col-4">
                                    ...
                                    <div class="col-9">
                                        <input type="date" value="{{ old('angsuran_3', @$ppdb->angsuran_3) }}"
                                            name="angsuran_3" class="form-control" onchange="handler(value,2)"
                                            id="2">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                        <input type="text"
                                            value="{{ old('cicilan_3', @$ppdb->cicilan_3) ?: $angsuran }}"
                                            name="cicilan_3" class="form-control" placeholder=""
                            ...
                            <div class="row table-row">
                                <div class="col-4">
                                    ...
                                    <div class="col-9">
                                        <input type="date" value="{{ old('angsuran_4', @$ppdb->angsuran_4) }}"
                                            name="angsuran_4" class="form-control" onchange="handler(value,3)"
                                            id="3">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                        <input type="text"
                                            value="{{ old('cicilan_4', @$ppdb->cicilan_4) ?: $angsuran }}"
                                            name="cicilan_4" class="form-control" placeholder=""
                            ...
                            <div class="row table-row">
                                <div class="col-4">
                                    ...
                                    <div class="col-9">
                                        <input type="date" value="{{ old('angsuran_5', @$ppdb->angsuran_5) }}"
                                            name="angsuran_5" class="form-control" onchange="handler(value,4)"
                                            id="4">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                        <input type="text"
                                            value="{{ old('cicilan_5', @$ppdb->cicilan_5) ?: $angsuran }}"
                                            name="cicilan_5" class="form-control" placeholder=""
                        ...
                        <div class="d-flex justify-content-center mt-2">
                            ...
                            <button type="submit" name="simpan-cicilan-temp" id="simpan-cicilan-temp"
                                class="btn btn-green" style="padding: 0.5rem 2rem"
                                onclick="clicked(event)">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function handler(value, month) {
            ...
            if (month == 0) {
                $('#info_angsuran_1').html(((date.getDate() > 9) ? date.getDate() : ('0' + date.getDate())) + '-' + ((date
                        .getMonth() > 8) ? (date.getMonth() + 1) : ('0' + (date.getMonth() + 1))) + '-' + date
                    .getFullYear());
            }

            if (month == 1) {
                $('#info_angsuran_2').html(((date.getDate() > 9) ? date.getDate() : ('0' + date.getDate())) + '-' + ((date
                        .getMonth() > 8) ? (date.getMonth() + 1) : ('0' + (date.getMonth() + 1))) + '-' + date
                    .getFullYear());
            }

            if (month == 2) {
                $('#info_angsuran_3').html(((date.getDate() > 9) ? date.getDate() : ('0' + date.getDate())) + '-' + ((date
                        .getMonth() > 8) ? (date.getMonth() + 1) : ('0' + (date.getMonth() + 1))) + '-' + date
                    .getFullYear());
            }

            if (month == 3) {
                $('#info_angsuran_4').html(((date.getDate() > 9) ? date.getDate() : ('0' + date.getDate())) + '-' + ((date
                        .getMonth() > 8) ? (date.getMonth() + 1) : ('0' + (date.getMonth() + 1))) + '-' + date
                    .getFullYear());
            }

            if (month == 4) {
                $('#info_angsuran_5').html(((date.getDate() > 9) ? date.getDate() : ('0' + date.getDate())) + '-' + ((date
                        .getMonth() > 8) ? (date.getMonth() + 1) : ('0' + (date.getMonth() + 1))) + '-' + date
                    .getFullYear());
            }
        }
