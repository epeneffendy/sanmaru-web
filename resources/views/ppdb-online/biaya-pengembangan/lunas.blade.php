            ...
            <div class="biaya-header col">
                <div class="row">
                    <div class="card-green">
                        ...
                        <span>Nominal uang pengembangan Anda <del>{{ \App\Helpers\PriceHelper::development($ppdb, true) }}</del> {{ \App\Helpers\PriceHelper::rupiah((95/100) * \App\Helpers\PriceHelper::development($ppdb)) }}</span>
                        @else
            ...
            <form id="form-development">
                <div class="row">
                    <div class="col">
                        ...
                        <p class="text-body">Silahkan download form surat pernyataan terlebih dahulu <a href="{{ route('ppdb.download-biaya-pengembangan', ['type' => 'lunas']) }}" target="_blank">disini</a></p>
