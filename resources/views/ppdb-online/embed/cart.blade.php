                ...
                <div class="row item">
                    <div class="item-upper">
                        ...
                        <div class="info">
                            ...
                            @else
                                <div
                                    class="info-harga">{{ \App\Helpers\PriceHelper::rupiah($detail->product_detail->price_ppdb) }}</div>
                            @endif
    ...
    <script>
        ...
        function calculateGrandTotal() {
            ...
            $.each(products, function (index, element) {
                if (element.include && element.qty > 0) {
                    ...
                    if (voucher.type === 'free_product' ) {
                        console.log(voucher)
                        var discount_product = $('#total_discount_validate').val();
                        // dt = parseInt(element.price);
                        dt = parseInt(discount_product);
            ...
            if (dt > 0 && gt > 0) {
                ...
                $('#grand_total_with_discount_validate').val(discount);
            } else {
