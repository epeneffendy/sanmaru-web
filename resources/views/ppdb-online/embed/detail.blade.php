        ...
        <div class="row">
            ...
            <div class="col">
                <div class="row content-detail">
                    {{-- <a href="{{ route('ppdb.embed-product.index') }}" class="link-back"></a>
                    <a href="{{ route('ppdb.embed-product.cart') }}" class="link-cart"></a> --}}

                    <h1 class="text-black">{{ $product->name }}</h1>
                    <span class="text-subtitle-2 text-light-green">{{ $product->price_ppdb_range }}</span>
...
<div class="wrapper-content-mobile">
    <div class="row mb-3 d-flex justify-content-between px-4">
        ...
        <a href="{{ route('ppdb.embed-product.cart') }}"><img src="{{asset('frontend-ppdb-online/img/Icon/Cart-Active.png')}}" alt=""></a>
    </div>
    <div class="row">
        <img src="{{ $product->image }}" class="header-image" />
    </div>
    <div class="row content-detail">
        ...
        <div class="text-body text-primary-green">{{ $product->price_ppdb_range }}</div>
                ...
                <div class="modal-detail-content">
                    <div class="content-header">
                        ...
                        <div class="content-header-right">
                            {{ $product->name }}
                            <span class="content-header-price" id="label-harga">{{ $product->price_ppdb_range }}</span>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('click', '#button-lanjutkan', function(e) {
            ...
            $.post('{{ route('ppdb.embed-product.post-product') }}', {
                _token: '{{ csrf_token() }}',
                id: product_id,
