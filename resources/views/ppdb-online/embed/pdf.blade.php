            ...
            <table>
                <tbody>
                    <tr>
                        <td>Nama</td>
                        <td>:</td>
                        <td>{{ $productOrder->ppdb_user->name }}</td>
                    </tr>
                    <tr>
                        <td>Unit</td>
                        <td>:</td>
                        <td>{{ $productOrder->ppdb_user->unit->name }}</td>
                    </tr>
                    <tr>
                        <td>Periode</td>
                        <td>:</td>
                        <td>{{ $productOrder->ppdb_user->period->name }}</td>
                    </tr>
                    <tr>
                        <td>No. Registrasi</td>
                        <td>:</td>
                        <td>{{ $productOrder->ppdb_user->register_number }}<td>
                    </tr>
                    <tr>
                        <td>No. Telp</td>
                        <td>:</td>
                        <td>{{ $productOrder->ppdb_user->user->mobile_phone }}</td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>:</td>
                        <td>{{ $productOrder->ppdb_user->user->email }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
                ...
                <td width="70%" style="vertical-align: top">
                    ...
                    <ol>
                        <li>
                                ...
                                menghubungi admin seragam yayasan di nomor +62 812-3201-3008 (Whatsapp) atau 0315673967 (Telp.).
                        </li>
                        <br/>
                        <li>
