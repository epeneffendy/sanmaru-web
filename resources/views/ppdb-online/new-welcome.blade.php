                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="total">
                                        ...
                                        <div
                                            class="total-item">{{ \App\Helpers\PriceHelper::rupiah($user->total_payment_form) }}</div>
                                    </div>
                                </div>
                            </div>
            ...
            @if ($user->status != \App\Models\PPDBUser::STATUS_COMPLETE && $user->status != \App\Models\PPDBUser::STATUS_INCOMPLETE)
                ...
                <div class="container" style="padding: 3rem">
                    <div class="" style="padding-bottom: 2rem">
                        @if($user->payment_option == 'BCA')
                            @if ($user->isAccepted)
                                <img src="{{asset('frontend-ppdb-online/img/progress-bar/Progress Bar 5.png')}}" alt=""
                                     class="progress-bar-ppdb">
                            @elseif ($user->isDataCompleteWhitoutBca && $user->isNewStatusStageDone())
                                <img src="{{asset('frontend-ppdb-online/img/progress-bar/Progress Bar 4.png')}}" alt=""
                                     class="progress-bar-ppdb">
                            @elseif ($user->isDataCompleteWhitoutBca)
                                <img src="{{asset('frontend-ppdb-online/img/progress-bar/Progress Bar 3.png')}}" alt=""
                                     class="progress-bar-ppdb">
                            @else
                                <img src="{{asset('frontend-ppdb-online/img/progress-bar/Progress Bar 2.png')}}" alt=""
                                     class="progress-bar-ppdb">
                            @endif
                        @else
                                        ...
                                        @if ($user->isAccepted)
                                            <span class="text-subtitle-1 status-detail">
                                                 <div class="status-tab status-tab-green-full">
                                                     Pendaftaran anda telah berhasil diselesaikan, silahkan pantau informasi selanjutnya melalui dashboard
                                                 </div>

                                            </span>
                                            <br>
                                        @else
                                            <span class="text-subtitle-1 status-detail">Pendaftaran sudah kami terima, silahkan melanjutkan pengisian kelengkapan data pada tahap berikutnya</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="status-indicator">
                                    <div class="">
                                        @if ($user['payment_option'] == 'BCA')
                                            <div
                                                class="status-circle status-circle-{{ @$user->isStatusCompleteWhitoutBca ? 'green' : 'red' }}"></div>
                                        @else
                                            <div
                                                class="status-circle status-circle-{{ @$user->isStatusComplete ? 'green' : 'red' }}"></div>
                                        @endif
                                        ...
                                        <div class="status-container">
                                            <div class="status-indicator">
                                                <div class="">
                                                    ...
                                                    @else
                                                        <div
                                                            class="status-circle status-circle-{{ $stage->passed == 'LOLOS' ? 'green' : 'red' }}"></div>
                                                    @endif
                                                </div>
                                                <div class="col-5">
                                                    <span
                                                    ...
                                                    @if($stage->passed == '-')
                                                        <div class="status-tab status-tab-yellow-full">
                                                            @if($stage->is_opening_development_feature)
                                                                ...
                                                                @else
                                                                    <span style="color: #555555"><i
                                                                            class="fa fa-file-excel-o"></i>Menunggu Verifikasi</span>
                                                                @endif
                                                            @else
                                                                <span style="color: #555555"><i
                                                                        class="fa fa-file-excel-o"></i>Info</span>
                            ...
                            <div class="status-container">
                                ...
                                <div class="status-description">
                                    ...
                                    @else
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="status-tab status-tab-{{ @$user->isStatusComplete ? 'green' : 'red' }}">
                                                <img class="green"
                                                     src="{{asset('frontend-ppdb-online/img/Icon/Tab/check.png')}}"
                                                     alt="">
                                                <img class="red"
