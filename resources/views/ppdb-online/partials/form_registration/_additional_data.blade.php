...
<div class="row">
    @if ($inputs->get('nama_saudara_se_sekolah'))
        <div class="col-md-12 mb-4">
            <div class="form-group custom-form-group">
                <label class="form-label fw-bold text-muted mb-2">Nama Saudara</label>
                <div class="input-group modern-input-group">
        ...
        <div class="form-group custom-form-group">
            ...
            <div class="input-group modern-input-group">
                <input type="number" name="nik_ortu"
                       ...
                       class="form-control required" placeholder="NIK Orang Tua / Wali">
            </div>
        </div>
    </div>
</div>
    ...
    @if ($inputs->get('alamat_sesuai_kk'))
        <div class="col-md-12 mb-4">
            <div class="form-group custom-form-group">
                ...
                <div class="input-group modern-input-group">
                    <textarea class="form-control required" name="alamat_sesuai_kk" rows="3"
