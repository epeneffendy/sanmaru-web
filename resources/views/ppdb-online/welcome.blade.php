    ...
    <div class="row row-height container-desktop">
        <div class="col content-top" id="start">
            <div id="wizard_container">
                ...
                <br>
                <form id="wrapped" method="POST" enctype="multipart/form-data" action="{{ route('ppdb.welcome.submit') }}">
                    <div>
                        ...
                        <p class="text-welcome">
                            Lengkapi data identitas dan dokumen administrasi dibawah ini untuk memudahkan proses penerimaan
                            siswa baru.
                        </p>
                        ...
                        <div class="container data-siswa-table">
                            ...
                            <div class="row table-header-row">
                                <div class="col-5">
                                    <p class="table-header">Kelengkapan</p>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    <a href="{{ route('ppdb.form-student') }}">
                                        <div class="status-tab status-tab-grey">
                                            <img class="grey"
                                                src="{{ asset('frontend-ppdb-online/img/Icon/Tab/edit.png') }}"
                                                alt="">
                                            <span>Edit</span>
                                        </div>
                                    </a>
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-3">
                                        <div class="input-group mb-3">
                                            <small>
                                                Sudah terbayarkan dengan Virtual Account <b> {{ @$user['payment_option'] }}
                                                </b> pada <b> {{ date('d-m-Y H:i:s', strtotime($user['payment_date'])) }}
                                                </b>
                                            </small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row table-row">
                                        ...
                                        <div class="col-4">
                                            @if (!empty(@$user['payment_form']))
                                                <div class="status-tab status-tab-green" id="message_payment_form"
                                                    role="alert">
                                                    <a target="_blank" class="d-flex align-items-center"
                                                        href="{{ $user->getPaymentFormImageUrl() }}">
                                                        <img class="green"
                                                            src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                            alt="">
                                                        <img class="check-green"
                                ...
                                <div class="row table-row">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                <div class="status-tab status-tab-grey status-tab-edit">
                                                    <img class="grey"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/folder.png') }}"
                                                        alt="">
                                                    <span>Browse</span>
                                                </div>
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['birth_certificate']))
                                            <div class="status-tab status-tab-green" id="message_birth_certificate"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getBirtCertificateImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['family_card']))
                                            <div class="status-tab status-tab-green" id="message_family_card"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getFamilyCardImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-3">
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                ...
                                                <input type="file" name="parent_identity_card"
                                                    class="custom-file-input" accept="image/x-png,image/jpeg"
                                                    id="parent_identity_card" aria-describedby="inputGroupFileAddon01">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['parent_identity_card']))
                                            <div class="status-tab status-tab-green" id="message_parent_identity_card"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getParentIdentityCardImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                ...
                                <div class="row table-row">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                ...
                                                <input type="file" name="marriage_certificate"
                                                    class="custom-file-input" accept="image/x-png,image/jpeg"
                                                    id="marriage_certificate" aria-describedby="inputGroupFileAddon01">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['marriage_certificate']))
                                            <div class="status-tab status-tab-green" id="message_marriage_certificate"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getMarriageCertificateImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                ...
                                @forelse (@$user['report_cards'] as $report)
                                    <div class="row table-row">
                                        <div class="col-5">
                                            <div class="input-group mb-3">
                                                <label class=""
                                                    style="white-space: nowrap;overflow: auto;">{{ str_replace('report_card/', '', $report) }}</label>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <a class="btn-green btn-sm" target="_blank"
                                                href="{{ \App\Helpers\ImageHelper::imageUrl($report) }}">Lihat File</a>
                                            <button class="btn-red delete-report-image btn-sm"
                                                data-filename="{{ str_replace('report_card/', '', $report) }}">Hapus</button>
                                        </div>
                                    </div>
                                @empty
                                @endforelse
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['award_photo']))
                                            <div class="status-tab status-tab-green" id="message_award_photo"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getAwardPhotoImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-3">
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                ...
                                                <input type="file" name="kartu_golongan_darah"
                                                    class="custom-file-input" accept="image/x-png,image/jpeg"
                                                    id="kartu_golongan_darah" aria-describedby="inputGroupFileAddon01">
                                                <label class="custom-file-label" for="award_photo"
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['kartu_golongan_darah']))
                                            <div class="status-tab status-tab-green" id="message_kartu_golongan_darah"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getKartuGolonganDarahImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                        ...
                                        @else
                                            <div class="alert alert-danger" id="message_kartu_golongan_darah"
                                                role="alert">
                                                Belum Lengkap
                                            </div>
                                ...
                                <div class="row table-row">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                ...
                                                <input type="file" class="custom-file-input"
                                                    name="baptismal_certificate" accept="image/x-png,image/jpeg"
                                                    id="baptismal_certificate" aria-describedby="inputGroupFileAddon01">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['baptismal_certificate']))
                                            <div class="status-tab status-tab-green" id="message_baptismal_certificate"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getBaptismalCertificateImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['rekomendasi_bk']))
                                            <div class="status-tab status-tab-green" id="message_rekomendasi_bk"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getRekomendasiBkImageUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                            ...
                            @if ($input = $uploadsForm->get('nilai_raport'))
                                <div class="row table-row">
                                    ...
                                    <div class="col-7">
                                        ...
                                        @isset($customForm)
                                            <a href="{{ $customForm->show_url }}" class="btn-green google-form"
                                                style="margin: 0">Form</a>
                                        @endisset
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['angket_peminatan']))
                                            <div class="status-tab status-tab-green" id="message_angket_peminatan"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getAngketPeminatanFileUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                                ...
                                <div class="row table-row">
                                    ...
                                    <div class="col-4">
                                        @if (!empty(@$user['statement_letter']))
                                            <div class="status-tab status-tab-green" id="message_statement_letter"
                                                role="alert">
                                                <a target="_blank" class="d-flex align-items-center text-white"
                                                    href="{{ $user->getStatementLetterFileUrl() }}">
                                                    <img class="green"
                                                        src="{{ asset('frontend-ppdb-online/img/Icon/Tab/check.png') }}"
                                                        alt="">
                                                    <img class="check-green"
                        ...
                        <ul class="btn-below">
                            @if (@$user->isReadyToSubmit)
                                <li>
                                    <button type="button" name="register" class="btn btn-register"
                                        onclick="popupRegister()">Simpan & Lanjut</button>
                                </li>
                            @else
                                <li>
                                    <button type="button" name="register" class="btn btn-register btn-disabled">Simpan &
                                        Lanjut</button>
                                </li>
                            @endif
                        </ul>
...
@push('scripts')
    ...
    <script>
        ...
        $('.google-form').click(function(e) {
            e.preventDefault();
            $(this).parent().append(
                '<iframe width="100%" height="500px" style="overflow-y: auto;" frameborder="0" src="' + $(this)
                .attr('href') + '"></iframe>');
            $(this).remove();
        });
