                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 content-right" id="start">
                        <div id="wizard_container">
                            ...
                            <!-- /top-wizard -->
                            <form id="wrapped" method="POST" action="{{ route('login.submit') }}" autocomplete="off">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="username" name="username" class="form-control required" placeholder="Username"
                                                value="{{ old('username') }}" onchange="getVals(this, 'username');" required>
                                    </div>
                                    {{-- <div class="form-group">
                                        <input type="password" name="password" class="form-control required" placeholder="Password"
                                                value="{{ old('password') }}" onchange="getVals(this, 'password');" required>
                                    </div> --}}
                                    <div class="form-group" id="show_hide_password">
                                        <input type="password" class="form-control mb-2 required" id="password" name="password" placeholder="Password" value="{{ old('password') }}" onchange="getVals(this, 'password');" required>
