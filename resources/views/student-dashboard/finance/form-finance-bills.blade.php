                                    ...
                                    <div class="px-3 px-md-4">
                                        ...
                                        @foreach ($bills as $item)
                                            @if ($item['type'] == 'registrasi')
                                                @include('student-dashboard.finance.partial._registration_form')
                                            @endif

                                            @if ($item['type'] == 'development')
                                                @include('student-dashboard.finance.partial._development_form')
                                            @endif


                                            @if ($item['type'] == 'activity')
                                                @include('student-dashboard.finance.partial._activity_form')
                                            @endif

                                            @if ($item['type'] == 'tuition')
                                                @include('student-dashboard.finance.partial._tuition_form')
                                            @endif
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.btn-receipt').on('click', function(e) {
                    ...
                    var url = "{{ route('registration-payment-receipt', ':id') }}";
