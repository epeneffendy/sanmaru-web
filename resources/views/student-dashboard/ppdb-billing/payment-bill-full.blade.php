...
@section('content')
    ...
    <div class="container py-5 payment-container">
        ...
        <!-- Tombol Aksi -->
        <div class="mt-4">
            <a href="{{ route('bills.check-payment-status', ['virtual_account_number' => $virtual_account_number, 'dispensation_type' => $dispensation_type]) }}"
            ...
            @if (!empty($virtual_account_unpaid))
                <a href="{{ route('bills.payment-cancel', ['virtual_account_number' => $virtual_account_number, 'dispensation_type' => $dispensation_type]) }}"
            ...
            <a href={{ route('finance-bills') }} class="btn btn-block text-secondary mt-3"
