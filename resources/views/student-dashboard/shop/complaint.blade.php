                                        ...
                                        <div class="col">
                                            <div class="pemesanan-item-info">
                                                ...
                                                @if($item->status == \App\Models\ComplaintOrders::STATUS_PICKUP)
                                                    <hr>
                                                    <div class="text-title-3 font-italic text-black mt-2"
                                                         style="font-weight: bold">Tanggal Pengambilan
                                                    </div>
                                                    <div class="text-title-3 font-italic text-black">
                                                        {{ \Carbon\Carbon::parse($item->date_pickup)->format('d-m-Y') }}
                                                    </div>

                                                    <div class="text-title-3 font-italic text-black mt-2"
                                                         style="font-weight: bold">Tempat Pengambilan
                                                    </div>
                                                    <div class="text-title-3 font-italic text-black">
                                                        {{ $item->location_pickup }}
                                                    </div>
                                                @endif
                                                ...
                                                <div class="col-md-12" style="display: flex">
                                                    ...
                                                    <div
                                                        ...
                                                        @if ($item->status === \App\Models\ComplaintOrders::STATUS_WAITING)
                                                            ...
                                                            <br>
                                                            <a href="{{ route('embed-product.cancel-complaint',['id'=>$item->id]) }}"
