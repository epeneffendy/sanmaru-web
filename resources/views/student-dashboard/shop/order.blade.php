                ...
                <div class="col">
                    ...
                    <div class="pembayaran">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('embed-product.detail-payment', ['id' => $order->id]) }}"
                                ...
                                <div class="pembayaran-item">
                                    <div class="pembayaran-item__content">
                                        ...
                                        <a class="btn btn-green" style="margin-top: 10px"
                                           href="{{ route('embed-product.order.pdf', $order->id) }}">
                                            <img class="icon-active"
                                                 src="{{asset('frontend-ppdb-online/img/Icon/Data-Normal.png')}}" alt=""
                                                 style="margin-right: 10px">
                                            Download
                                        </a>
                                        <div style="color: black; margin-top: 20px">QR code ditunjukkan kepada petugas
                                            saat
                                            pengambilan seragam
                                        </div>
                                        <button class="btn" style="margin-top: 10px" data-toggle="modal"
                                            ...
                                            <img class="icon-active"
                                                 src="{{asset('frontend-ppdb-online/img/Icon/qr-code-icon.png')}}"
                                                 alt=""
                                                 width="30px">
                                        </button>
                                    </div>
                            ...
                            <div class="pembayaran" id="qr-code">
                                ...
                                <div class="pembayaran-item">
                                    <div class="pembayaran-item__content">
                                        ...
                                        <a class="btn btn-green" style="margin-top: 10px"
                                           href="{{ route('embed-product.complaint', ['product_order' => $order->id]) }}"
                                           target="_blank">
                                            Komplain
                                        </a>
                                    </div>
        ...
        $(document).on('click', '.post-cancel-order', function (e) {
            ...
            if (success) {
                swal({
                    ...
                    if (result) {
                        $.post('{{ route('embed-product.post-cancel-order') }}', {
                            _token: '{{ csrf_token() }}',
                            product_order_id: id,
