    ...
    <div class="container" style="padding: 3rem">
        ...
        <div class="row">
            ...
            <div class="col">
                @if ($order->voucher)
                @php
                    $voucher = json_decode($order->voucher, TRUE);
                @endphp
                <div class="voucher">
                ...
                <div class="pembayaran">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('embed-product.detail-payment', ['id' => $order->id]) }}" class="text-subtitle-3 text-grey">lihat detail</a>
                    </div>
                    <div class="pembayaran-item">
                        <div class="pembayaran-item__title">Bank {{ \App\Helpers\PriceHelper::paymentInfo($user->class->unit, \App\Helpers\Helper::isVaBcaEnable() ? 'BCA' : NULL)['bank'] }} <span class="{{ \App\Helpers\PriceHelper::paymentInfo($user->class->unit, \App\Helpers\Helper::isVaBcaEnable() ? 'BCA' : NULL)['bank'] }}"></span></div>
                    ...
                    <div class="pembayaran-item">
                        <div class="pembayaran-item__content">
                            ...
                            <div style="display: flex; align-items:center; margin:1rem 0">
                                <button class="btn btn-sm btn-green upload-file-button"><img src="{{asset('frontend-ppdb-online/img/Icon/upload.png')}}" alt=""><span class="text-white">Upload</span></button>
                            </div>
                ...
                <div class="pembayaran" id="qr-code">
                    ...
                    <div class="pembayaran-item">
                        <div class="pembayaran-item__content">
                            ...
                            <a class="btn btn-green" style="margin-top: 10px" href="{{ route('embed-product.order.pdf', $order->id) }}">
...
<div class="wrapper-content-mobile">
    <div class="row pl-3">
        <a href="{{ route('embed-product.order-list') }}" class="d-flex align-items-center justify-content-around"><img class="head-left" src="{{asset('frontend-ppdb-online/img/Icon/Icon-Arrow.png')}}" alt=""><span class="text-body-title text-primary-green ml-2">Kembali</span></a>
        {{-- <a href="{{ route('embed-product.order-list') }}" class="arrow-back"></a> --}}
    ...
    <div class="pembayaran">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('embed-product.detail-payment', ['id' => $order->id]) }}" class="title text-grey">lihat detail</a>
        </div>
        <div class="pembayaran-item">
        ...
        <div class="pembayaran-item">
            <div class="pembayaran-item__content">
                ...
                <div style="display: flex; justify-content:center; align-items:center">
                    <button class="btn btn-sm btn-green upload-file-button">Upload bukti pembayaran</button>
                </div>
                <form id="wrapped" method="POST" enctype="multipart/form-data">
                    <input type="file" name="payment_image" id="upload_file" accept="image/x-png,image/jpeg,application/pdf" />
                    <input type="hidden" name="id" value={{ $order->id }} />
        ...
        $(document).on('change', '#upload_file', function() {
            if ($(this).val()) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: "{{route('embed-product.upload-order-confirmation')}}",
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
