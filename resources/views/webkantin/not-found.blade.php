                ...
                <div class="mt-48">
                    ...
                    <div class="d-flex justify-content-center my-4">
                        <div class="image-wrapper">
                            <img src="{{asset('webkantin/images/menu-not-found.png')}}" alt="Kantin Santa Maria">
                        </div>
                    </div>
                    <div class="text-center">
                        <h5 class="display-xs bold black-solid">Ooppsss</h5>
                        <p class="text-md reguler grey">Sorry banget nih, makanan yang kamu cari saat ini belum tersedia</p>
                    </div>
                </div>          
            </div>
        </div>
