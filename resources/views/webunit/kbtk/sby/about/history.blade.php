    ...
    <div class="timeline">
      ...
      <div class="timeline-body row ">
        ...
        <div class="col-lg-7">
          ...
          <div class="title-5 mint-green mobile-version">{{ $about->title }}</div>
        ...
        <div class="col-lg-5 desktop-version">
          ...
          <div class="history-image">
            ...
            <img class="picture" src="{{ $about->getFeaturedImageUrl() }}" alt="">
            <img class="vector-1" src="{{asset('web-kbtk/sby/images/image-vector-1.png')}}" alt="">
            <img class="vector-2" src="{{asset('web-kbtk/sby/images/image-vector-2.png')}}" alt="">
          </div>
          @endif
        </div>
      </div>
