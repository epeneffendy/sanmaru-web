...
<div class="container">
  <div class="about-nav">
    <a class="title-5 grey active" href="{{ route('webunit.about.history', ['webunit' => $webUnit, 'unit' => $webunit_level]) }}">
      History
    </a>
    <a class="title-5 grey" href="{{ route('webunit.about.about', ['webunit' => $webUnit, 'unit' => $webunit_level]) }}">
      About
    </a>
  ...
  <div id="history">
    <div class="timeline">
      ...
      <div class="timeline-body row ">
        ...
        @endif
        <div class="col-lg-7">
          <div class="timeline-date body-text-20 orange desktop-version">{{ $about->title }}</div>
          <div class="title-5 orange mobile-version">{{ $about->title }}</div>
        ...
        <div class="col-lg-5 desktop-version">
          ...
          <div class="history-image">
            ...
            <img class="picture" src="{{ $about->getFeaturedImageUrl() }}" alt="">
            <img class="vector-1" src="{{asset('web-kbtk/sda/images/image-vector-1.png')}}" alt="">
            <img class="vector-2" src="{{asset('web-kbtk/sda/images/image-vector-2.png')}}" alt="">
          </div>
          @endif
        </div>
      </div>
