@extends('layouts.webunit.kbtk.sda.main')
@section('content')
...
<div id="home">
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-7 left">
								<h3 class="grey">KB-TK Santa Maria</h3>
							...
							<div class="col-lg-5 col-md-5 right">
								<img src="{{ asset('web-kbtk/sda/images/hero-illustration.png') }}" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
					<div class="card core-value">
						...
						<img class="card-img-top" src="{{asset('web-kbtk/sda/icons/illustration-monster-1.svg')}}" alt="Card image cap">
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
					<div class="card core-value">
						<div class="subtitle-2">Integritas</div>
						<img class="card-img-top" src="{{asset('web-kbtk/sda/icons/illustration-monster-2.svg')}}" alt="Card image cap">
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
					<div class="card core-value">
						<div class="subtitle-2">Keberanian dan Ketangguhan</div>
						<img class="card-img-top" src="{{asset('web-kbtk/sda/icons/illustration-monster-3.svg')}}" alt="Card image cap">
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
					<div class="card core-value">
						<div class="subtitle-2">Semangat Persatuan</div>
						<img class="card-img-top" src="{{asset('web-kbtk/sda/icons/illustration-monster-4.svg')}}" alt="Card image cap">
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
					<div class="card core-value">
						<div class="subtitle-2">Kesungguhan (Totalitas)</div>
						<img class="card-img-top" src="{{asset('web-kbtk/sda/icons/illustration-monster-5.svg')}}" alt="Card image cap">
					</div>
				</div>
				<div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
					<div class="card core-value">
						<div class="subtitle-2">Semangat Pelayanan</div>
						<img class="card-img-top" src="{{asset('web-kbtk/sda/icons/illustration-monster-6.svg')}}" alt="Card image cap">
					</div>
				</div>
			</div>
		</div>
    ...
    <img class="butterfly-bg" src="{{asset('web-kbtk/sda/images/butterfly-bg.png')}}"  alt="">
		<div class="container">
			<div class="d-inline-block">
