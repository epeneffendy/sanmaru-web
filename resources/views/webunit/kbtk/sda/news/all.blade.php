  ...
  <div class="container">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex mb-4 desktop-version">
        <button class="btn btn-outline-orange body-text-14 orange mr-2">
        ...
        <div class="dropdown">
          <button class="btn btn-outline-orange dropdown-toggle body-text-14 orange" type="button" id="dropdownSortBy" data-bs-toggle="dropdown" aria-expanded="false">
          Sort by
          </button>
