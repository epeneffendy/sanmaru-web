    ...
    <!-- <div class="row">
      <div class="col-lg-4 col-4">
        <div class="welcome-image desktop-version">
          ...
          <img class="picture" src="{{asset('web-sd/sby/images/welcome-image.png')}}" alt="">
          <img class="vector-1" src="{{asset('web-sd/sby/images/welcome-image-vector-1.png')}}" alt="">
          <img class="vector-2" src="{{asset('web-sd/sby/images/welcome-image-vector-2.png')}}" alt="">
        </div>
