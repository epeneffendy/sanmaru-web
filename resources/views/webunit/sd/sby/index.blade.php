    ...
    <section id="hero-section">
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-7 col-md-7 left">
								<h3 class="green-salad">SD Santa Maria</h3>
							...
							<div class="col-lg-5 col-md-5 right">
								<img src="{{ asset('web-sd/sby/images/sd-illustration.png') }}" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="carousel-inner">
				...
				<div class="jumbotron jumbotron-fluid" style="background: linear-gradient(to right, {{$headline->color_overlay}}, rgba(0, 0, 0, 0)), url('{{$headline->getUrl()}}') no-repeat; background-size: cover; background-position: 70% center;">
					<div class="container">
                        <div class="row">
                            <div class="col-lg-7 col-md-7 left">
                                <h3 class="white">SD Santa Maria</h3>
        ...
        <section id="home-section-1">
            <div class="container">
                ...
                <p class="body-text-16 mt-3 grey">Our alumni share their experiences of studying with us and discuss how our community have supported them in their careers</p>
                    ...
                    <div class="news-carousel-inner">
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <a href="{{route('webunit.news.show', ['webunit' => $webUnit, 'slug' => $blog->slug])}}">
                                    <div class="card-body text-left">
                                        <p class="body-text-14 white m-0">{{ \App\Helpers\Helper::tanggal($blog->created_at) }}</p>
                                        <p class="body-text-18 white m-0"> <strong>{{ $blog->title }}</strong></p>
                                    </div>
                                </a>
                            </div>
                        </div>
        ...
        <section id="home-extra-section">
            <div class="container">
                <div class="d-inline-block">
                    <h4 class="title-5 airplane black-panther">Why Our School is the Best</h4>
                </div>
                <p class="body-text-16 mt-3 grey">We regard our students as unique learners and challenge them to do their very best with the best educational programme in the world today</p>
                <div class="row">
                    <div class="col-md-6 mobile-version text-center">
                        <div class="image-wrapper">
                            <img src="{{ asset('web-sd/sby/images/program-1.png') }}" alt="" class="large">
                            <img src="{{ asset('web-sd/sby/images/program-1.png') }}" alt="" class="small">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <ul class="text-left">
                            <li class="body-text-18 black-panther">Sekolah Berkarakter SERVIAM</li>
                            <li class="body-text-18 black-panther">Ramah Anak</li>
                            <li class="body-text-18 black-panther">Adiwiyata Mandiri</li>
                            <li class="body-text-18 black-panther">Pramuka</li>
                            <li class="body-text-18 black-panther">IT Handal</li>
                        </ul>
                    </div>
                    <div class="col-md-6 desktop-version">
                        <div class="image-wrapper">
                            <img src="{{ asset('web-sd/sby/images/program-1.png') }}" alt="" class="large">
                            <img src="{{ asset('web-sd/sby/images/program-1.png') }}" alt="" class="small">
                        </div>
        ...
        <section id="home-section-2">
            <div class="container">
                ...
                <p class="body-text-16 mt-3 grey">Our school promotes a learning community in which our core values <br>
                    represent the guidelines of our behavior</p>
                <div class="row">
                    <div class="col-6 mobile-version">
                        <div class="core-value-item">
                            <img src="{{ asset('web-sd/sby/images/ic-cinta.png') }}" alt="">
                            <p class="body-text-16 black-panther">Cinta dan Belas Kasih</p>
                        </div>
                        <div class="core-value-item">
                            <img src="{{ asset('web-sd/sby/images/ic-integritas.png') }}" alt="">
                            <p class="body-text-16 black-panther">Integritas</p>
                        </div>
                        <div class="core-value-item">
                            <img src="{{ asset('web-sd/sby/images/ic-keberanian.png') }}" alt="">
                            <p class="body-text-16 black-panther">Keberanian dan Ketangguhan</p>
                        </div>
                    </div>
                    <div class="col-6 mobile-version">
                        <div class="d-flex flex-column justify-content-center h-100">
                            <div class="core-value-item">
                                <img src="{{ asset('web-sd/sby/images/ic-persatuan.png') }}" alt="">
                                <p class="body-text-16 black-panther">Semangat Persatuan</p>
                            </div>
                            <div class="core-value-item">
                                <img src="{{ asset('web-sd/sby/images/ic-kesungguhan.png') }}" alt="">
                                <p class="body-text-16 black-panther">Kesungguhan (Totalitas)</p>
                            </div>
                            <div class="core-value-item">
                                <img src="{{ asset('web-sd/sby/images/ic-pelayanan.png') }}" alt="">
                                <p class="body-text-16 black-panther">Semangat Pelayanan</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 desktop-version">
                        <div class="d-flex flex-column justify-content-center h-100">
                            <div class="core-value-item left">
                                <p class="body-text-16 black-panther">Cinta dan Belas Kasih</p>
                                <img src="{{ asset('web-sd/sby/images/ic-cinta.png') }}" alt="">
                            </div>
                            <div class="core-value-item left">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('web-sd/sby/images/core-value-illustration.png') }}" class="illustration" alt="Core Values">
                    </div>
                    <div class="col-md-3 desktop-version">
                        <div class="d-flex flex-column justify-content-center h-100">
                            <div class="core-value-item right">
                                <img src="{{ asset('web-sd/sby/images/ic-persatuan.png') }}" alt="">
                                <p class="body-text-16 black-panther">Semangat Persatuan</p>
                            </div>
                            <div class="core-value-item right">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5" >
                        ...
                        <p class="body-text-16 mt-3 grey">For more than 60 years, we have been providing high quality learning programs</p>
                    </div>
