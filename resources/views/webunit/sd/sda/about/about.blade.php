    ...
    <div class="container">
      <div class="row">
        <div class="col-6 d-flex align-items-stretch">
          <div class="card">
            <img class="card-img-top" src="{{asset('web-sd/sda/images/keunggulan-1.png')}}" alt="">
            <div class="card-body">
        ...
        <div class="col-6 d-flex align-items-stretch">
          <div class="card">
            <img class="card-img-top" src="{{asset('web-sd/sda/images/keunggulan-2.png')}}" alt="">
            <div class="card-body">
        ...
        <div class="col-6 d-flex align-items-stretch">
          <div class="card">
            <img class="card-img-top" src="{{asset('web-sd/sda/images/keunggulan-3.png')}}" alt="">
            <div class="card-body">
        ...
        <div class="col-6 d-flex align-items-stretch">
          <div class="card">
            <img class="card-img-top" src="{{asset('web-sd/sda/images/keunggulan-4.png')}}" alt="">
            <div class="card-body">
