...
<div class="container">
  <div class="about-nav">
    <a class="title-5 grey active" href="{{ route('webunit.about.history', ['webunit' => $webUnit]) }}">
      History
    </a>
      ...
      <div class="timeline-body row ">
        ...
        <div class="col-lg-5 desktop-version">
          ...
          <div class="history-image">
            ...
            <img class="picture" src="{{ $about->getFeaturedImageUrl() }}" alt="">
            <img class="vector-1" src="{{asset('web-sd/sda/images/image-vector-1.png')}}" alt="">
            <img class="vector-2" src="{{asset('web-sd/sda/images/image-vector-2.png')}}" alt="">
          </div>
          @endif
        </div>
      </div>
