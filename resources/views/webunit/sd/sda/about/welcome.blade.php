...
<div class="container">
  <div class="about-nav">
    ...
    <a class="title-5 grey" href="{{ route('webunit.about.about', ['webunit' => $webUnit]) }}">
      About
    </a>
    <a class="title-5 grey active" href="{{ route('webunit.about.welcome', ['webunit' => $webUnit]) }}">
      A Warm Welcome
    </a>
  </div>
    ...
    <!-- <div class="row">
      <div class="col-lg-4 col-4">
        <div class="welcome-image desktop-version">
          ...
          <img class="picture" src="{{asset('web-sd/sda/images/welcome-image.png')}}" alt="">
          <img class="vector-1" src="{{asset('web-sd/sda/images/welcome-image-vector-1.png')}}" alt="">
          <img class="vector-2" src="{{asset('web-sd/sda/images/welcome-image-vector-2.png')}}" alt="">
        </div>
      ...
      <div class="col-lg-8 col-8">
        <h4 class="title-5 blue-sky mt-4 mb-4">
          Drs. Samuel Sugiyono
        </h4>
        <p class="body-text-16 grey">
