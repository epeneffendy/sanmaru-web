...
@section('content')
    ...
    <div id="home">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 col-md-7 left">
                                    ...
                                    <h1 class="title-2 green-salad">Pemimpin yang Berjiwa Ecopreneur</h1>
                                ...
                                <div class="col-lg-5 col-md-5 right">
                                    <img src="{{ asset('web-sd/sda/images/sd-illustration.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 col-md-7 left">
                                    ...
                                    <h1 class="title-2 white">Pemimpin yang Berjiwa Ecopreneur</h1>
                ...
                <div class="row">
                    <div class="col-6 mobile-version">
                        <div class="core-value-item">
                            <img src="{{ asset('web-sd/sda/images/ic-cinta.png') }}" alt="">
                            <p class="body-text-16 black-panther">Cinta dan Belas Kasih</p>
                        </div>
                        <div class="core-value-item">
                            <img src="{{ asset('web-sd/sda/images/ic-integritas.png') }}" alt="">
                            <p class="body-text-16 black-panther">Integritas</p>
                        </div>
                        <div class="core-value-item">
                            <img src="{{ asset('web-sd/sda/images/ic-keberanian.png') }}" alt="">
                    ...
                    <div class="col-6 mobile-version">
                        <div class="d-flex flex-column justify-content-center h-100">
                            <div class="core-value-item">
                                <img src="{{ asset('web-sd/sda/images/ic-persatuan.png') }}" alt="">
                                <p class="body-text-16 black-panther">Semangat Persatuan</p>
                            </div>
                            <div class="core-value-item">
                                <img src="{{ asset('web-sd/sda/images/ic-kesungguhan.png') }}" alt="">
                                <p class="body-text-16 black-panther">Kesungguhan (Totalitas)</p>
                            </div>
                            <div class="core-value-item">
                                <img src="{{ asset('web-sd/sda/images/ic-pelayanan.png') }}" alt="">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('web-sd/sda/images/core-value-illustration.png') }}" class="illustration" alt="Core Values">
                    </div>
                    <div class="col-md-3 desktop-version">
                        <div class="d-flex flex-column justify-content-center h-100">
        ...
        <section id="home-section-4">
            <img class="butterfly-bg" src="{{ asset('web-sd/sda/images/butterfly-bg.png') }}" alt="">
            <div class="container">
                <div class="d-inline-block">
