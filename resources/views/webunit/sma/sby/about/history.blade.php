...
@section('content')
    ...
    <div class="container">
        <div id="history">
            <h4 class="title-1 green-salad desktop-version" style="margin: 102px 0 93px 0">
                <strong>HISTORY</strong> 
            </h4>
            <h4 class="title-3 green-salad mobile-version mb-4">
                <strong>HISTORY</strong> 
            </h4>
            <div class="timeline">
                ...
                <div class="timeline-body row ">
                    ...
                    <div class="history-image">
                        ...
                        <img class="picture" src="{{ $about->getFeaturedImageUrl() }}" alt="">
                        <img class="vector-1" src="{{asset('web-sma/sby/images/image-vector-1.png')}}" alt="">
                        <img class="vector-2" src="{{asset('web-sma/sby/images/image-vector-2.png')}}" alt="">
                    </div>
                    @endif
                    </div>
                </div>
