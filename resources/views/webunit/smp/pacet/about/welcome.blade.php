...
@section('content')
    ...
    <div class="container">
        <div class="about-nav">
            ...
            <a class="body-text-20 dark-purple active" href="{{ route('webunit.about.welcome', ['webunit' => $webUnit]) }}">
                A WARM WELCOME
            </a>
        </div>
        ...
        <div id="welcome">
            ...
            <!-- <div class="row">
                <div class="col-lg-4 col-4">
                    ...
                    <img class="picture" src="{{asset('web-smp/pacet/images/welcome-image.png')}}" alt="">
                    <img class="vector-1" src="{{asset('web-smp/pacet/images/welcome-image-vector-1.png')}}" alt="">
                    <img class="vector-2" src="{{asset('web-smp/pacet/images/welcome-image-vector-2.png')}}" alt="">
                    </div>
