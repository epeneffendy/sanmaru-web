...
@section('content')
    <div class="news-bg desktop-version">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h2 class="heading-2 dark-purple">News & <br> Updates </h2>
                    <!-- <div class="headline-news-category body-text-14 dark-purple">Pengumuman</div> -->
                </div>
            </div>
        </div>
    </div>
    <section id="all-news">
        <div class="container">
            ...
            <h4 class="title-3 airplane black-panther mb-4">All News</h4>
            <div class="d-flex mb-4 desktop-version">
                <button class="btn btn-outline-oak-green body-text-14 oak-green mr-2">
                ...
                <div class="dropdown">
                <button class="btn btn-outline-oak-green dropdown-toggle body-text-14 oak-green" type="button" id="dropdownSortBy" data-bs-toggle="dropdown" aria-expanded="false">
                Sort by
                </button>
