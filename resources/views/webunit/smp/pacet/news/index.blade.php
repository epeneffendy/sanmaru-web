...
@section('content')
    ...
    <section id="popular-news">
        <div class="container">
            <h4 class="title-1 dark-purple d-inline-block">Popular News</h4>
            <div class="row desktop-version">
                ...
                <a href="{{route('webunit.news.show', ['webunit' => $webUnit, 'slug' => $headline->slug])}}">
                    ...
                    <div class="card-footer d-flex align-items-center">
                        <div class="news-category body-text-14 dark-purple">{{ @$headline->category->name }}</div>
                ...
                <a href="{{route('webunit.news.show', ['webunit' => $webUnit, 'slug' => $news->slug])}}">
                    ...
                    <div class="card-footer d-flex align-items-center">
                        <div class="news-category body-text-14 dark-purple">{{ @$news->category->name }}</div>
                        <i class="icon icon-clock ml-3 mr-2"></i>
    ...
    <section id="lastest-news">
        <div class="container">
            ...
            <h4 class="title-1 dark-purple">Lastest News</h4>
