					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-5 col-md-5 right">
								<img src="{{ asset('web-smp/sby/images/hero-illustration.png') }}" alt="">
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sby/icons/core-value-1.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Cinta dan Belas Kasih</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sby/icons/core-value-2.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Integritas</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sby/icons/core-value-3.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Keberanian dan Ketangguhan</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sby/icons/core-value-4.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Semangat Persatuan</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sby/icons/core-value-5.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Kesungguhan (Totalitas)</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sby/icons/core-value-6.svg')}}" alt="Card image cap">
