...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <!-- <div class="headline-news-category body-text-14 oak-green">Pengumuman</div> -->
                </div>
            </div>
        </div>
    </div>
    ...
    <section id="popular-news">
        <div class="container">
            <h4 class="title-1 black-panther d-inline-block">Popular News</h4>
    ...
    <section id="lastest-news">
        <div class="container">
            ...
            <h4 class="title-1 black-panther">Lastest News</h4>
