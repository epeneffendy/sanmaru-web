...
@section('content')
    ...
    <div class="container">
        <div class="about-nav">
            <a class="body-text-20 green-salad active" href="{{ route('webunit.about.history', ['webunit' => $webUnit]) }}">
                HISTORY
            </a>
        ...
        <div id="history">
            <div class="timeline">
                ...
                <div class="timeline-body row ">
                    ...
                    @endif
                    <div class="col-lg-7">
                    <div class="timeline-date body-text-20 black-panther desktop-version">{{ $about->title }}</div>
                    <div class="title-3 orange mobile-version">{{ $about->title }}</div>
                    ...
                    <div class="history-image">
                        ...
                        <img class="picture" src="{{ $about->getFeaturedImageUrl() }}" alt="">
                        <img class="vector-1" src="{{asset('web-smp/sda/images/image-vector-1.png')}}" alt="">
                        <img class="vector-2" src="{{asset('web-smp/sda/images/image-vector-2.png')}}" alt="">
                    </div>
                    @endif
                    </div>
                </div>
