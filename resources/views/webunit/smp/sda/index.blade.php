...
@section('content')
                ...
                <div class="modal-body">
                    <div id="CarouselPopup">
                        ...
                        <div class="carousel-inner">
                            <div class="row">
                                <div class="col-12">
                                    <h1 class="text-center orange">{{ $popup->title }}</h1>
    ...
    <div id="home">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 col-md-7 left">
                                    <h3 class="grey">SMP Santa Maria</h3>
                                    <h1 class="title-2 orange">Pemimpin yang Berjiwa Ecopreneur</h1>
                                ...
                                <div class="col-lg-5 col-md-5 right">
                                    <img src="{{ asset('web-smp/sda/images/hero-illustration.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="jumbotron jumbotron-fluid" style="background: linear-gradient(to right, {{$headline->color_overlay}}, rgba(0, 0, 0, 0)), url('{{$headline->getUrl()}}') no-repeat; background-size: cover; background-position: 70% center;">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 col-md-7 left">
                                    <h3 class="white">SMP Santa Maria</h3>
        ...
        <section id="home-section-1">
            <div class="container text-center">
                <div class="d-inline-block">
                    <h4 class="title-3 airplane green-salad">LATEST BLOGS AND ARTICLES</h4>
                </div>
        ...
        <section id="home-section-2">
            <div class="container text-center">
                <div class="d-inline-block">
                    <h4 class="title-3 airplane green-salad">OUR CORE VALUES</h4>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sda/icons/core-value-1.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Cinta dan Belas Kasih</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sda/icons/core-value-2.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Integritas</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sda/icons/core-value-3.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Keberanian dan Ketangguhan</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sda/icons/core-value-4.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Semangat Persatuan</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sda/icons/core-value-5.svg')}}" alt="Card image cap">
                            <div class="subtitle-2">Kesungguhan (Totalitas)</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-6 d-flex align-items-stretch">
                        <div class="card core-value">
                            <img class="card-img-top" src="{{asset('web-smp/sda/icons/core-value-6.svg')}}" alt="Card image cap">
        ...
        <section id="home-section-3">
            ...
            <div class="container mobile-version text-center">
                <div class="row">
                    <div class="col-md-5" >
                        <div class="d-inline-block">
                            <h4 class="title-3 airplane green-salad">OUR KEY ACHIEVEMENT</h4>
                        </div>
        ...
        <section id="home-section-4">
            <div class="container text-center">
                <div class="d-inline-block">
                    <h4 class="title-3 airplane green-salad">TESTIMONIALS</h4>
                </div>
        ...
        <section id="home-section-5">
            <div class="container text-center">
                <div class="d-inline-block">
                    <h4 class="title-3 airplane green-salad">GALLERY</h4>
                </div>
